    ...
    return (
        <>
            <div className="ease-in-out relative h-screen w-full bg-gradient-animated bg-[length:200%_200%] animate-gradient flex items-center justify-center">
                ...
                <button onClick={handleClick} className='duration-300 ease-in-out absolute ring ring-1 ring-white top-[85vh] rounded-md w-[20vw] h-[8vh] items-center justify-center font-outfit text-[1.2vw] font-thin hover:bg-[length:200%_200%] bg-text-gradient-animated animate-gradient-text bg-clip-text hover:text-transparent'>Start</button>           
            </div>
        </>
    );
}
